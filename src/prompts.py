...
7) Write my company name when describing it
7) Ask a catchy question in the end
8) Add Sales Manager instead of [Your Name]

User Facts and Summary: % {lead_facts_and_summary} %

Company facts and summary: % {company_facts_and_summary} %

Absolutely necessary use additional notes about company: {additional_notes}

Closest Chunks to user summary from RAG with Company Information: % {rag_chunks} %
